package mockomatik.classes.service.scan.impl;
...
public class ScanClassImpl implements ScanClass {
        ...
        try {
            ...
            for (File file : dir.listFiles()) {
                if (file.isFile() && file.getName().contains(".java")) {
                    ...
                    /*
                     * While loop acts as a content filter to gather reusable lines for test
                     * templates
                     */
    ...
    /**
     * Remove file extension and set the name of the file being read to string to
     * fileName
     * 
     * @param file
     */
